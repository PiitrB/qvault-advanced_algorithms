...
# It starts at the tree root (or some arbitrary node of a graph), and explores all of the neighbor 
...
# breadth_first_search takes a start vertex as input. It will traverse the graph in a 
# breadth-first manner and record the vertices it visits to a list. That list will be returned.
...
# Pop the last vertex off the to_visit list and visit it by appending it to visited
